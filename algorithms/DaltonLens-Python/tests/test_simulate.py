...
from daltonlens import convert, generate, simulate
...
class TestCVD(unittest.TestCase):
    ...
    def test_vienot1999(self):
        vienot1999 = simulate.Simulator_Vienot1999(
            convert.LMSModel_sRGB_SmithPokorny75(ignoreJuddVosCorrection=False)
        )
        ...
        models_to_test = [
            ...
            (
                ...
                0.55,
                "vienot1999_protan_0.55.png",
            ),
            (
                vienot1999,
                simulate.Deficiency.DEUTAN,
                0.55,
                "vienot1999_deutan_0.55.png",
            ),
            (
                vienot1999,
                simulate.Deficiency.TRITAN,
                0.55,
                "vienot1999_tritan_0.55.png",
            ),
        ]
    ...
    def test_brettel1997(self):
        ...
        models_to_test = [
            (
                ...
                simulate.Deficiency.PROTAN,
                1.0,
                "brettel1997_protan_wn_1.0.png",
            ),
            (
                brettel1997,
                simulate.Deficiency.DEUTAN,
                1.0,
                "brettel1997_deutan_wn_1.0.png",
            ),
            (
                brettel1997,
                simulate.Deficiency.TRITAN,
                1.0,
                "brettel1997_tritan_wn_1.0.png",
            ),
            (
                brettel1997,
                simulate.Deficiency.PROTAN,
                0.55,
                "brettel1997_protan_wn_0.55.png",
            ),
            (
                brettel1997,
                simulate.Deficiency.DEUTAN,
                0.55,
                "brettel1997_deutan_wn_0.55.png",
            ),
            (
                brettel1997,
                simulate.Deficiency.TRITAN,
                0.55,
                "brettel1997_tritan_wn_0.55.png",
            ),
        ]
    ...
    def test_vischeck(self):
        ...
        models_to_test = [
            (
                brettel1997_vischeck,
                simulate.Deficiency.PROTAN,
                1.0,
                "vischeck_gimp_protan.png",
            ),
            (
                brettel1997_vischeck,
                simulate.Deficiency.DEUTAN,
                1.0,
                "vischeck_gimp_deutan.png",
            ),
            (
                brettel1997_vischeck,
                simulate.Deficiency.TRITAN,
                1.0,
                "vischeck_gimp_tritan.png",
            ),
        ]
    ...
    def test_machado2009(self):
        ...
        models_to_test = [
            (
                ...
                simulate.Deficiency.PROTAN,
                1.0,
                "machado2009_protan_1.0.png",
            ),
            (
                machado2009,
                simulate.Deficiency.DEUTAN,
                1.0,
                "machado2009_deutan_1.0.png",
            ),
            (
                machado2009,
                simulate.Deficiency.TRITAN,
                1.0,
                "machado2009_tritan_1.0.png",
            ),
            (
                machado2009,
                simulate.Deficiency.PROTAN,
                0.55,
                "machado2009_protan_0.55.png",
            ),
            (
                machado2009,
                simulate.Deficiency.DEUTAN,
                0.55,
                "machado2009_deutan_0.55.png",
            ),
            (
                machado2009,
                simulate.Deficiency.TRITAN,
                0.55,
                "machado2009_tritan_0.55.png",
            ),
        ]
    ...
    def test_coblisV2(self):
        ...
        for deficiency in (
            ...
            out = coblisv2.simulate_cvd(im, deficiency, severity=1.0)
    ...
    def test_auto(self):
        ...
        # AutoSelect must route ACHROMAT and BCM correctly
        achromat = simulate.Simulator_Achromat()
        out_auto = auto.simulate_cvd(im, simulate.Deficiency.ACHROMAT, severity=1.0)
        out_ref = achromat.simulate_cvd(im, simulate.Deficiency.ACHROMAT, severity=1.0)
        self.assertTrue(np.allclose(out_auto, out_ref))

        bcm = simulate.Simulator_BCM()
        out_auto = auto.simulate_cvd(im, simulate.Deficiency.BCM, severity=1.0)
        out_ref = bcm.simulate_cvd(im, simulate.Deficiency.BCM, severity=1.0)
        self.assertTrue(np.allclose(out_auto, out_ref))
    ...
    def test_achromat(self):
        ...
        im = generate.rgb_span(27 * 8, 27 * 8)
        models_to_test = [
            (achromat, simulate.Deficiency.ACHROMAT, 1.0, "achromat_1.0.png"),
            (achromat, simulate.Deficiency.ACHROMAT, 0.55, "achromat_0.55.png"),
        ]
        self.checkModels(im, models_to_test, tolerance=1)
    ...
    def test_bcm(self):
        ...
        im = generate.rgb_span(27 * 8, 27 * 8)
        models_to_test = [
            (bcm, simulate.Deficiency.BCM, 1.0, "bcm_1.0.png"),
            (bcm, simulate.Deficiency.BCM, 0.55, "bcm_0.55.png"),
        ]
        self.checkModels(im, models_to_test, tolerance=1)
