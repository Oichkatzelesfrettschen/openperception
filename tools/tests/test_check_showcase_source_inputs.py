...
def test_validate_showcase_source_inputs_accepts_readable_inputs(
    ...
    json_path.write_text(
        '{"arrays": {"real_time_s": [0.0], "detector_strain_whitened_visual": [1.0]}}',
        encoding="utf-8",
    )
    monkeypatch.setattr(
...
def test_validate_showcase_source_inputs_rejects_missing_or_broken_inputs(
    monkeypatch, tmp_path
) -> None:
